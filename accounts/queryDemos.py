...
#(8)***Returns product from products table with value of "Out Door" in category attribute
...
'''
(11)Bonus
Q: If the customer has more than 1 ball, how would reflect it in the database?
...
Class ChildModel(models.Model):
    parent = models.ForeignKe(ParentModel)
    name = models.CharField(max_length=200, null=True)
